    ...
    async def get_exchange_rate():
        async with httpx.AsyncClient() as client:
            ...
            try:
                ...
                if picture2 < len(picture2):
                    # 索引在范围内，获取元素
                    element = picture2[picture2]
                    picture3 = 'https://robertsspaceindustries.com/' + element
                    url2 = picture3
                    ...
                    # 索引超出范围，使用默认值或其他逻辑
                    element = picture5  # 替换为你希望返回的默认值
            except IndexError:
                # 处理异常情况
                element = picture5  # 使用默认值
            ...
            try:
             ...
             #处理异常情况
                ...
                # 创建一个DataFrame
                data2 = {'玩家ID': [amount], '舰队名字': [name11], '舰队小名字': [name12], '舰队职位': [name13],
